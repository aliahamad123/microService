...
public class UdiseSchFacilityThreeBean {
	...
	public String getAhmvpRoomYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(ahmvpRoomYN);
	}
	...
	public String getComRoomGirlsYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(comRoomGirlsYN);
	}
	...
	public String getStaffRoomYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(staffRoomYN);
	}
	...
	public String getCraftRoomYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(craftRoomYN);
	}
	...
	public String getStaffQtrYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(staffQtrYN);
	}
	...
	public String getIntegratedLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(integratedLabYN);
	}
	...
	public String getLibraryRoomYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(libraryRoomYN);
	}
	...
	public String getTinkeringLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(tinkeringLabYN);
	}
	...
	public String getCompRoomYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(compRoomYN);
	}
	...
	public String getPhyLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(phyLabYN);
	}
	...
	public String getPhyLabCondition() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(phyLabCondition);
	}
	...
	public String getChemLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(chemLabYN);
	}
	...
	public String getChemLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(chemLabCond);
	}
	...
	public String getBoiLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(boiLabYN);
	}
	...
	public String getBioLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(bioLabCond);
	}
	...
	public String getMathLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(mathLabYN);
	}
	...
	public String getMathLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(mathLabCond);
	}
	...
	public String getLangLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(langLabYN);
	}
	...
	public String getLangLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(langLabCond);
	}
	...
	public String getGeoLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(geoLabYN);
	}
	...
	public String getGeoLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(geoLabCond);
	}
	...
	public String getHomescLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(homescLabYN);
	}
	...
	public String getHomeSCLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(homeSCLabCond);
	}
	...
	public String getPsychoLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(psychoLabYN);
	}
	...
	public String getPsychoLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(psychoLabCond);
	}
	...
	public String getCompLabYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(compLabYN);
	}
	...
	public String getCompLabCond() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(compLabCond);
	}
	...
	public String getAudioSystemYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(audioSystemYN);
	}
	...
	public String getSciencekitYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(sciencekitYN);
	}
	...
	public String getMathkitYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(mathkitYN);
	}
	...
	public String getBiometricDevYN() {
		return StaticMasterUtilityMethodes.checkResComLabPlayGCWSNYesNo(biometricDevYN);
	}
