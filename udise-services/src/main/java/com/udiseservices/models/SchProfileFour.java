...
@Document(collection = "sch_profile_4")
public class SchProfileFour {
	...
	public String toString() {
		return "SchProfileFour [_id=" + _id + ", schoolId=" + schoolId + ", udiseSchCode=" + udiseSchCode + ", acYear="
				+ acYear + ", cceYnEle1819=" + cceYnEle1819 + ", cceYnSec=" + cceYnSec + ", cceYnHsec=" + cceYnHsec
				+ ", pcrMaintainedYn=" + pcrMaintainedYn + ", pcrSharedYn=" + pcrSharedYn + ", rte25pApplied="
				+ rte25pApplied + ", rte25pEnrolled=" + rte25pEnrolled + ", rtePvtC0Boys=" + rtePvtC0Boys
				+ ", rtePvtC0Girls=" + rtePvtC0Girls + ", rtePvtC1Boys=" + rtePvtC1Boys + ", rtePvtC1Girls="
				+ rtePvtC1Girls + ", rtePvtC2Boys=" + rtePvtC2Boys + ", rtePvtC2Girls=" + rtePvtC2Girls
				+ ", rtePvtC3Boys=" + rtePvtC3Boys + ", rtePvtC3Girls=" + rtePvtC3Girls + ", rtePvtC4Boys="
				+ rtePvtC4Boys + ", rtePvtC4Girls=" + rtePvtC4Girls + ", rtePvtC5Boys=" + rtePvtC5Boys
				+ ", rtePvtC5Girls=" + rtePvtC5Girls + ", rtePvtC6Boys=" + rtePvtC6Boys + ", rtePvtC6Girls="
				+ rtePvtC6Girls + ", rtePvtC7Boys=" + rtePvtC7Boys + ", rtePvtC7Girls=" + rtePvtC7Girls
				+ ", rtePvtC8Boys=" + rtePvtC8Boys + ", rtePvtC8Girls=" + rtePvtC8Girls + ", rteEwsC0Boy=" + rteEwsC0Boy
				+ ", rteEwsC0Girl=" + rteEwsC0Girl + ", rteEwsC1Boy=" + rteEwsC1Boy + ", rteEwsC1Girl=" + rteEwsC1Girl
				+ ", rteEwsC2Boy=" + rteEwsC2Boy + ", rteEwsC2Girl=" + rteEwsC2Girl + ", rteEwsC3Boy=" + rteEwsC3Boy
				+ ", rteEwsC3Girl=" + rteEwsC3Girl + ", rteEwsC4Boy=" + rteEwsC4Boy + ", rteEwsC4Girl=" + rteEwsC4Girl
				+ ", rteEwsC5Boy=" + rteEwsC5Boy + ", rteEwsC5Girl=" + rteEwsC5Girl + ", rteEwsC6Boy=" + rteEwsC6Boy
				+ ", rteEwsC6Girl=" + rteEwsC6Girl + ", rteEwsC7Boy=" + rteEwsC7Boy + ", rteEwsC7Girl=" + rteEwsC7Girl
				+ ", rteEwsC8Boy=" + rteEwsC8Boy + ", rteEwsC8Girl=" + rteEwsC8Girl + ", rteEwsC9Boy=" + rteEwsC9Boy
				+ ", rteEwsC9Girl=" + rteEwsC9Girl + ", rteEwsC10Boy=" + rteEwsC10Boy + ", rteEwsC10Girl="
				+ rteEwsC10Girl + ", rteEwsC11Boy=" + rteEwsC11Boy + ", rteEwsC11Girl=" + rteEwsC11Girl
				+ ", rteEwsC12Boy=" + rteEwsC12Boy + ", rteEwsC12Girl=" + rteEwsC12Girl + ", spltrgYn=" + spltrgYn
				+ ", spltrgCyProvGirls=" + spltrgCyProvGirls + ", spltrgCyProvBoys=" + spltrgCyProvBoys
				+ ", spltrgPyEnrolBoys=" + spltrgPyEnrolBoys + ", spltrgPyEnrolGirls=" + spltrgPyEnrolGirls
				+ ", spltrgPyProvBoys=" + spltrgPyProvBoys + ", spltrgPyProvGirls=" + spltrgPyProvGirls + ", spltrgBy="
				+ spltrgBy + ", spltrgPlace=" + spltrgPlace + ", spltrgType=" + spltrgType + ", remedialTchEnrol="
				+ remedialTchEnrol + ", sessionStartMon=" + sessionStartMon + ", txtbkRecdYn=" + txtbkRecdYn
				+ ", txtbkRecdMon=" + txtbkRecdMon + ", txtbkRecdYear1819=" + txtbkRecdYear1819 + ", suppMatRecdYn="
				+ suppMatRecdYn + ", txtbkPrePriYn1819=" + txtbkPrePriYn1819 + ", txtbkPriYn=" + txtbkPriYn
				+ ", txtbkUprYn=" + txtbkUprYn + ", txtbkSecYn=" + txtbkSecYn + ", txtbkHsecYn=" + txtbkHsecYn
				+ ", tlePrePriYn1819=" + tlePrePriYn1819 + ", tlePriYn=" + tlePriYn + ", tleUprYn=" + tleUprYn
				+ ", tleSecYn=" + tleSecYn + ", tleHsecYn=" + tleHsecYn + ", playmatPrePriYn1819=" + playmatPrePriYn1819
				+ ", playmatPriYn=" + playmatPriYn + ", playmatUprYn=" + playmatUprYn + ", playmatSecYn=" + playmatSecYn
				+ ", playmatHsecYn=" + playmatHsecYn + ", noInspect=" + noInspect + ", noVisitCrc=" + noVisitCrc
				+ ", noVisitBrc=" + noVisitBrc + ", noVisitDis=" + noVisitDis + ", cceYnPri=" + cceYnPri + ", cceYnUpr="
				+ cceYnUpr + ", createdBy1819=" + createdBy1819 + ", created_time=" + created_time + ", modified_by="
				+ modified_by + ", modified_time=" + modified_time + "]";
	}
