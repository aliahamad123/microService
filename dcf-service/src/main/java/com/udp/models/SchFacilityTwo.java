...
public class SchFacilityTwo {
	...
	private String handPumpTot;
	
	@Field(value = "hand_punp_fun")
	private String handPunpFun;
	
	@Field(value = "well_prot_tot")
	private String wellProtTot;
	
	@Field(value = "well_prot_fun")
	private String wellProtFun;
	...
	public String getHandWashYN() {
		return handWashYN;
	}

	public void setHandWashYN(String handWashYN) {
		this.handWashYN = handWashYN;
	}

	public String getHandPumpTot() {
		return handPumpTot;
	}

	public void setHandPumpTot(String handPumpTot) {
		this.handPumpTot = handPumpTot;
	}

	public String getHandPunpFun() {
		return handPunpFun;
	}

	public void setHandPunpFun(String handPunpFun) {
		this.handPunpFun = handPunpFun;
	}

	public String getWellProtTot() {
		return wellProtTot;
	}

	public void setWellProtTot(String wellProtTot) {
		this.wellProtTot = wellProtTot;
	}

	public String getWellProtFun() {
		return wellProtFun;
	}

	public void setWellProtFun(String wellProtFun) {
		this.wellProtFun = wellProtFun;
	}
