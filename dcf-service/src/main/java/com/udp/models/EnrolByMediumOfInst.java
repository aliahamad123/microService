...
@Document(collection = "enrolByMediumOfInst")
public class EnrolByMediumOfInst {
	...
	@Field(name = "medinstr_type")
	private String medinstrType;

	@Field(name = "medinstr_seq")
	private String medinstrSeq;
	...
	public String getMedinstrType() {
		return medinstrType;
	}

	public void setMedinstrType(String medinstrType) {
		this.medinstrType = medinstrType;
	}

	public String getMedinstrSeq() {
		return medinstrSeq;
	}

	public void setMedinstrSeq(String medinstrSeq) {
		this.medinstrSeq = medinstrSeq;
	}
